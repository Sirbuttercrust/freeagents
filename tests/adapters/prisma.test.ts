  ...
  it('create: sends every stored field, including the brief, and projects it back', async () => {
    ...
    expect(Object.keys(row).sort()).toEqual(
      [
        ...
        'stagedCommit',
        'redoUsedCount',
        'redoRequestedCriterionIndex',
        'redoRequestedAt',
        'redoRefusedAt',
        'stagedLapseExtensionDays',
        'citedCloseCriterionIndex',
        'citedCloseReasonText',
        'citedCloseAuthorDid',
        'citedCloseAt',
        'deemedCompletedAt',
        'stagingRepo',
  ...
  it('update: sends every field except the id and projects the row back', async () => {
    ...
    expect(mock.jobUpdate).toHaveBeenCalledWith({
      ...
      data: {
        ...
        redoUsedCount: updated.redoUsedCount,
        redoRequestedCriterionIndex: updated.redoRequestedCriterionIndex,
        redoRequestedAt: updated.redoRequestedAt,
        redoRefusedAt: updated.redoRefusedAt,
        stagedLapseExtensionDays: updated.stagedLapseExtensionDays,
        citedCloseCriterionIndex: updated.citedCloseCriterionIndex,
        citedCloseReasonText: updated.citedCloseReasonText,
  ...
  it('complete: sends the full completed payload, including the merge columns, and projects it back', async () => {
    ...
    expect(mock.jobUpdate).toHaveBeenCalledWith({
      ...
      data: {
        ...
        redoUsedCount: completedFixture.redoUsedCount,
        redoRequestedCriterionIndex: completedFixture.redoRequestedCriterionIndex,
        redoRequestedAt: completedFixture.redoRequestedAt,
        redoRefusedAt: completedFixture.redoRefusedAt,
        stagedLapseExtensionDays: completedFixture.stagedLapseExtensionDays,
        citedCloseCriterionIndex: completedFixture.citedCloseCriterionIndex,
        citedCloseReasonText: completedFixture.citedCloseReasonText,
